module atm2lndType
  ...
  type, public :: atm2lnd_type
     ...
     !real(r8), pointer :: parflow_h2osoi_liq_grc        (:,:) => null() ! Parflow soil liquid water
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    !allocate(this%parflow_h2osoi_liq_grc        (begg:endg,1:nlevgrnd)); this%parflow_h2osoi_liq_grc     (:,:) = ival
  ...
  subroutine InitHistory(this, bounds)
    ...
    call hist_addfld1d (fname='VOLRMCH',  units='m3',  &
     ...
     call hist_addfld2d (fname='PARFLOW_PSI', units='mm', type2d='levgrnd', &
          avgflag='A', long_name='Parflow pressure head', &
          ptr_lnd=this%parflow_psi_grc, default='inactive')

     ! this%parflow_h2osoi_liq_grc(begg:endg, :) = 0._r8
     ! call hist_addfld2d (fname='PFL_SOILLIQ_G', units='', type2d='levgrnd', &
     !      avgflag='A', long_name='Parflow soil liquid', &
     !      ptr_lnd=this%parflow_h2osoi_liq_grc, default='inactive')
